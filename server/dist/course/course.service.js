...
let CourseService = class CourseService {
    ...
    async changeApprovalState(body, manager) {
        try {
            ...
            await this.emailService.sendMailToUser(course["0"].users["0"].email, `你申报的${course["0"].courseName}, 管理员已更新状态为${ApprovalState[Number(body.approvalState)]}, 请登陆系统查看。 详情请登陆http://www.tms.leondon.cn`);
            return {
                code: 0,
                message: '更新课程审批状态成功'
            };
